...
SMODS.Achievement { -- The Whole Gang
    ...
    unlock_condition = function(self, args)
        if args.type == "modify_jokers" then
            ...
            local soksjokers = 0
            local sephirajokers = 0
            local joseeejokers = 0
            local foxxlyduskfurjokers = 0
            ...
            for i = 1, #G.jokers.cards do
                ...
                elseif G.jokers.cards[i].config.center.key == "j_fur_sparkles" or "j_fur_corruptsparkles" or "j_fur_talismancorruptsparkles" then
                    sparklesjokers = sparklesjokers + 1
                ...
                elseif G.jokers.cards[i].config.center.key == "j_fur_curiousangel" or "j_fur_corruptcuriousangel" or "j_fur_talismancorruptcuriousangel" then
                    angeljokers = angeljokers + 1
                elseif G.jokers.cards[i].config.center.key == "j_fur_skips" or "j_fur_multiplayerskips" then
                ...
                elseif G.jokers.cards[i].config.center.key == "j_fur_sephirapaws" or G.jokers.cards[i].config.center.key == "j_fur_talismansephirapaws" then
                    sephirajokers = sephirajokers + 1
                elseif G.jokers.cards[i].config.center.key == "j_fur_xavierorjose" or G.jokers.cards[i].config.center.key == "j_fur_talismanxavierorjose" then
                    joseeejokers = joseeejokers + 1
                elseif G.jokers.cards[i].config.center.key == "j_fur_foxxlyduskfur" then
                    foxxlyduskfurjokers = foxxlyduskfurjokers + 1
                end

                if silverjokers >= 1 and astraljokers >= 1 and kalikjokers >= 1 and saphjokers >= 1 and cobaltjokers >= 1 and iceseajokers >= 1 and sparklesjokers >= 1 and sparkjokers >= 1 and konekojokers >= 1 and angeljokers >= 1 and skipsjokers >= 1 and ghostjokers >= 1 and illyjokers >= 1 and luposityjokers >= 1 and soksjokers >= 1 and sephirajokers >= 1 and joseeejokers >= 1 and foxxlyduskfurjokers >= 1 then
                    return true
                end
            end
        end
