...
SMODS.Booster { -- Mini Uncommon
    ...
    create_card = function(self, card, i)
        return create_card("uncommonfurries", G.pack_cards, nil, nil, true, true, nil, 'uncommon')
    end,
...
SMODS.Booster { -- Mini Rare
    ...
    create_card = function(self, card, i)
        return create_card("rarefurries", G.pack_cards, nil, nil, true, true, nil, 'rare')
    end,
...
SMODS.Booster { -- Mini Legendary
    ...
    create_card = function(self, card, i)
        return create_card("legendaryfurries", G.pack_cards, nil, nil, true, true, nil, 'legendary')
    end,
...
SMODS.Booster { -- Mini Mythic
    ...
    create_card = function(self, card, i)
        return create_card("mythicfurries", G.pack_cards, nil, nil, true, true, nil, 'mythic')
    end,
