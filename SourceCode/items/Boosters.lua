...
SMODS.Booster { -- Pack 8 (Special)
    ...
    create_card = function(self, card, i)
        local possible = {'j_fur_sparkles', 'j_fur_illy', 'j_fur_ghost', 'j_fur_soks', 'j_fur_kalik', 'j_fur_silver', 'j_fur_astral', 'j_fur_cobalt', 'j_fur_icesea', 'j_fur_koneko', 'j_fur_saph', 'j_fur_skips', 'j_fur_spark', 'j_fur_luposity', 'j_fur_curiousangel'}
        local _edition = poll_edition('standard_edition'..G.GAME.round_resets.ante, 2, false, true)
        return {set = 'Joker', edition = _edition, area = G.pack_cards, skip_materialize = true, key = pseudorandom_element(possible, pseudoseed('furry' .. G.GAME.round_resets.ante)), key_append = "fur"}
    end,
...
SMODS.Booster { -- Pack 11 (Mythic)
    ...
    create_card = function(self, card)
        local possible = {'j_fur_illy', 'j_fur_ghost', 'j_fur_soks', 'j_fur_skips', 'j_fur_luposity', 'j_fur_curiousangel'}
        local _edition = poll_edition('standard_edition'..G.GAME.round_resets.ante, 2, false, true)
        return {set = 'Joker', edition = _edition, area = G.pack_cards, skip_materialize = true, key = pseudorandom_element(possible, pseudoseed('furry' .. G.GAME.round_resets.ante)), key_append = "fur"}
    end,
