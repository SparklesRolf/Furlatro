			...
			func = function()
				...
				if G.consumeables then
					...
					if G.GAME.selected_sleeve == "sleeve_fur_stargazerssleeve" then
						...
						cardtype = "Tarot"
						cardspawn = "c_fur_fallingstar"
					end

					local card = create_card(cardtype, G.consumeables, nil, nil, nil, nil, cardspawn, 'starsleeve')
        	    	local card2 = create_card(cardtype, G.consumeables, nil, nil, nil, nil, cardspawn, 'starsleeve')
					card:add_to_deck()
					card2:add_to_deck()
