...
SMODS.Enhancement { -- Prince Cards
    ...
    calculate = function(self, card, context)
        ...
        if next(SMODS.find_mod("partner")) then
            if next(SMODS.find_card("j_fur_lume")) and G.GAME.selected_partner == "pnr_fur_lumepartner" then
                if card.ability.partnersynergizetrigger == "False" or card.ability.extra.multgain == 4 then
                    card.ability.partnersynergizetrigger = "True"
                    card.ability.extra.multgain = card.ability.extra.multgain * 2
                end
            elseif not next(SMODS.find_card("j_fur_lume")) and G.GAME.selected_partner == "pnr_fur_lumepartner" then
                if card.ability.partnersynergizetrigger == "True" or card.ability.extra.multgain == 8 then
                    card.ability.partnersynergizetrigger = "False"
                    card.ability.extra.multgain = card.ability.extra.multgain / 2
                end
            end
        end
