    ...
    calculate = function(self, card, context)
        ...
        if next(SMODS.find_mod("partner")) then
            if G.GAME.selected_partner == "pnr_fur_curiousangelpartner" then
                if card.ability.partnersynergizetrigger == "False" or card.ability.extra.gain == 1 then
...
if Talisman then -- Danny
    SMODS.Joker {
        ...
        config = { isflush = "False", extra = { emult = 1, emultgain = 0.1 }},
        atlas = 'dannyslab',
        pos = { x = 1, y = 0 },
        soul_pos = { x = 0, y = 0 },
        rarity = "fur_rarityfurry",
        ...
        calculate = function(self, card, context)
            ...
            if next(SMODS.find_mod("partner")) then
                if G.GAME.selected_partner == "pnr_fur_dannypartner" then
                    if card.ability.partnersynergizetrigger == "False" or card.ability.extra.emultgain == 0.1 then
                        card.ability.partnersynergizetrigger = "True"
        ...
        update = function(self, card, dt) -- From Cryptid
            local complexbackground = config.complex_jokers.current_option
            local jokerref = card.config.center
            if not G.GAME.selected_partner == "pnr_fur_dannypartner" then
    ...
    calculate = function(self, card, context)
        ...
        if next(SMODS.find_mod("partner")) then
            if G.GAME.selected_partner == "pnr_fur_ghostpartner" then
                if card.ability.partnersynergizetrigger == "False" or card.ability.extra.gain == 0.25 then
                    card.ability.partnersynergizetrigger = "True"
                    card.ability.extra.gain = card.ability.extra.gain * 2
                end
            end
...
SMODS.Joker {
    key = 'iridia',
    config = { partnersynergizetrigger = "False", spawnplanet = "False", extra = { xchips = 1.75, xmult = 1.75 }},
    atlas = 'iridiaslab',
    pos = { x = 1, y = 0 },
    soul_pos = { x = 0, y = 0 },
    rarity = "fur_rarityfurry",
    ...
    calculate = function(self, card, context)
        ...
        if next(SMODS.find_mod("partner")) then
                if G.GAME.selected_partner == "pnr_fur_iridiapartner" then
                    if card.ability.partnersynergizetrigger == "False" or (card.ability.extra.xchips == 1.75 and card.ability.extraxmult == 1.75) then
                        card.ability.partnersynergizetrigger = "True"
...
if Talisman then -- Kris_57
        ...
        calculate = function(self, card, context)
            ...
            if next(SMODS.find_mod("partner")) then
                if G.GAME.selected_partner == "pnr_fur_kris57partner" then
                    if card.ability.partnersynergizetrigger == "False" or (card.ability.extra.echipsgain == 0.5 and card.ability.extra.emultgain == 0.5) then
                        card.ability.partnersynergizetrigger = "True"
    ...
    SMODS.Joker {
        ...
        calculate = function(self, card, context)
            ...
            if next(SMODS.find_mod("partner")) then
                if G.GAME.selected_partner == "pnr_fur_kris57partner" then
                    if card.ability.partnersynergizetrigger == "False" or (card.ability.extra.xchipsgain == 0.5 and card.ability.extra.xmultgain == 0.5) then
                        card.ability.partnersynergizetrigger = "True"
                        card.ability.extra.money = card.ability.extra.money * 2
        ...
        calculate = function(self, card, context)
            ...
            if next(SMODS.find_mod("partner")) then
                if G.GAME.selected_partner == "pnr_fur_sephirapawspartner" then
                    if card.ability.partnersynergizetrigger == "False" or card.ability.extra.emultgain == 0.25 then
                        card.ability.partnersynergizetrigger = "True"
                        card.ability.extra.emultgain = card.ability.extra.emultgain * 2
                    end
                end
    ...
    calculate = function(self, card, context)
        ...
        if next(SMODS.find_mod("partner")) then
            if G.GAME.selected_partner == "pnr_fur_sokspartner" then
                if card.ability.partnersynergizetrigger == "False" or card.ability.extra.bonus_hands == 1 then
                    card.ability.partnersynergizetrigger = "True"
