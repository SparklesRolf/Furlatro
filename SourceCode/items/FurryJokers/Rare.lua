        ...
        calculate = function(self, card, context)
            ...
            if next(SMODS.find_mod("partner")) then
                if G.GAME.selected_partner == "pnr_fur_dannypartner" then
                    if card.ability.partnersynergizetrigger == "False" or card.ability.extra.xmultgain == 0.1 then
    ...
    calculate = function(self, card, context)
        ...
        if next(SMODS.find_mod("partner")) then
            if G.GAME.selected_partner == "pnr_fur_nemzatapartner" then
                if card.ability.partnersynergizetrigger == "False" or card.ability.extra.money == 5 then
                    card.ability.partnersynergizetrigger = "True"
