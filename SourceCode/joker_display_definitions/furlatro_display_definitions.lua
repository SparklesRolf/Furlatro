...
jd_def["j_fur_sephirapaws"] = { -- SephiraPaws
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_fur_talismansephirapaws"] = { -- SephiraPaws (Talisman)
    text = {
        {
            border_nodes = {
                { text = "^" },
...
jd_def["j_fur_xavierorjose"] = { -- Joseeeeee
    text = {
...
jd_def["j_fur_talismanxavierorjose"] = { -- Joseeeeee (Talisman)
    text = {
        { text = "$ = ", colour = G.C.MONEY },
...
jd_def["j_fur_foxxlyduskfur"] = { -- FoxxlyDuskFur
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_fur_corruptcuriousangel"] = { -- Corrupt CuriousAngel
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_fur_talismancorruptcuriousangel"] = { -- Corrupt CuriousAngel (Talisman)
    text = {
        {
            border_nodes = {
                { text = "^" },
...
jd_def["j_fur_corruptsparkles"] = { -- Corrupt Sparkles
    text = {
        {
            border_nodes = {
                { text = "X" },
...
jd_def["j_fur_talismancorruptsparkles"] = { -- Corrupt Sparkles (Talisman)
    text = {
        {
            border_nodes = {
                { text = "^" },
