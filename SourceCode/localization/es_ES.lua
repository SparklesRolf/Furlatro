return {
    ["descriptions"] = {
        ...
        ["Joker"] = {
            ...
            ["j_fur_foxxlyduskfur"] = {
                ...
                ["text"] = {"Este Zorro gana {X:mult,C:white}X#2#{} Mult",
                            ...
                            "rápido si tienes {C:attention}Atardecer",
                            "{C:inactive}(Actualmente {X:mult,C:white}X#1#{C:inactive} Mult)",
        ...
        ["Mod"] = {
            ["Furlatro"] = {
                ["name"] = "Furlatro",
                ["text"] = {
                    "{C:edition,E:1,s:1.3}EL{} modpack Furry para Balatro. ¡Un proyecto de pasión llevado a la vida!",
                    " ",
                    "Introduce {C:attention}38 {C:dark_edition,E:1,s:1.3}Jokers Furry{}, ¡cada uno con efectos únicos!",
    ...
    ["misc"] = {
        ...
        ["poker_hand_descriptions"] = {
            ...
            ["fur_straightspectrum"] = {"5 cartas que tienen", "palos únicos y están en una", "fila (rangos consecutivos)"},
