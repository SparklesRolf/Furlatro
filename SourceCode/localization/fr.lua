return {
	["descriptions"] = {
		...
		["Partner"] = {
			...
			["pnr_fur_aberrantreptilepartner"] = {
				["name"] = "AberrantReptile",
				["text"] = {
					"This Lizard gains {X:mult,C:white}X#3#{} Mult",
					"for every {C:attention}2nd{} card {C:attention}created",
					"{C:inactive}(Currently {X:mult,C:white}X#2#{C:inactive} Mult)",
					"{C:inactive}({C:attention}#1#{C:inactive} Remaining)",
				},
			},
			["pnr_fur_aberrantreptilepartner_alt"] = {
				["name"] = "AberrantReptile",
				["text"] = {
					"{C:attention}Double{} the scaling",
	...
	["misc"] = {
		...
		["dictionary"] = {
			...
			["fur_jdcardcreated"] = "Card Created",
