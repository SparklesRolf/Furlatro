    ...
    SMODS.Joker {
        ...
        calculate = function(self, card, context)
            ...
            if context.destroy_card and context.cardarea == G.hand and not context.blueprint then
			    if not (context.destroy_card:is_suit('fur_stars') or context.destroy_card:is_suit('six_Stars')) then
			    	return { remove = true }
			    end
            end
            ...
            if context.selling_self then
                ...
                for i = 1, #G.jokers.cards do
                    if G.jokers.cards[i].config.center.key == "j_fur_talismancorruptdanny" then
        ...
        remove_to_deck = function(self, card, from_debuff)
            local dannycards = 0
            for i = 1, #G.jokers.cards do
                if G.jokers.cards[i].label == "j_fur_talismancorruptdanny" then
                    dannycards = dannycards + 1
                end
            end
    ...
    SMODS.Joker {
        ...
        calculate = function(self, card, context)
            ...
            if context.selling_self then
                local dannycards = 0
                for i = 1, #G.jokers.cards do
                    if G.jokers.cards[i].config.center.key == "j_fur_corruptdanny" then
                        dannycards = dannycards + 1
                    end
                end
        ...
        remove_to_deck = function(self, card, from_debuff)
            local dannycards = 0
            for i = 1, #G.jokers.cards do
                if G.jokers.cards[i].label == "j_fur_corruptdanny" then
                    dannycards = dannycards + 1
                end
            end
...
local corruptiridia_lines = { -- iridia (Corrupted)
    normal = {
        '"12\'012\'12\'00\'12\'0"',
        '"Dark days emerge"',
    },
...
if Talisman then
    SMODS.Joker {
        key = "talismancorruptiridia",
        config = { dtpassed = 0, extra = { emult = 0, money = 0 }},
        atlas = 'corruptiridiaslab',
        pos = { x = 1, y = 0 },
        soul_pos = { x = 0, y = 0 },
        rarity = "fur_rarityfurrycorrupt",
        pools = {
        ...
        calculate = function(self, card, context)
            if card.debuff then return nil end
            if context.individual and context.cardarea == G.play then
                if context.other_card:get_id() == 5 or context.other_card:get_id() == 7 or context.other_card:is_suit("Clubs") or context.other_card:is_suit("Diamonds") then
                    return {
                        emult = card.ability.extra.emult,
                        colour = G.C.DARK_EDITION
                    }
            ...
            if context.other_joker and 
                (context.other_joker.config.center.rarity == "fur_rarityfurrynonmythic" or context.other_joker.config.center.rarity == "fur_rarityfurrymythic" or context.other_joker.config.center.rarity == "fur_rarityfurrycorrupt")
            ...
            if config.joker_lines then
                main_start = {
                    { n = G.UIT.R, config = { align = "tm", padding = 0.02 }, nodes = {
                        { n = G.UIT.T, config = { text = localize("fur_corruptediridia_1"), colour = G.C.UI.TEXT_DARK, scale = 0.32 }},
                        { n = G.UIT.O, config = {
                            object = DynaText({
                                string = multtable,
                        ...
                        { n = G.UIT.T, config = { text = localize("fur_corruptediridia_2"), colour = G.C.UI.TEXT_DARK, scale = 0.32 } },
                        { n = G.UIT.T, config = { text = "5", colour = G.C.FILTER, scale = 0.32 } },
                        { n = G.UIT.T, config = { text = localize("fur_corruptediridia_3"), colour = G.C.UI.TEXT_DARK, scale = 0.32 } },
                        { n = G.UIT.T, config = { text = "7", colour = G.C.FILTER, scale = 0.32 } },
                        { n = G.UIT.T, config = { text = localize("fur_corruptediridia_3"), colour = G.C.UI.TEXT_DARK, scale = 0.32 } },
                    }},
                    { n = G.UIT.R, config = { align = "cm", padding = 0.02 }, nodes = {
                        { n = G.UIT.T, config = { text = localize("Clubs", "suits_plural"), colour = G.C.SUITS.Clubs, scale = 0.32 } },
                        { n = G.UIT.T, config = { text = localize("fur_corruptediridia_4"), colour = G.C.UI.TEXT_DARK, scale = 0.32 } },
                        { n = G.UIT.T, config = { text = localize("Diamonds", "suits_plural"), colour = G.C.SUITS.Diamonds, scale = 0.32 } },
                        { n = G.UIT.T, config = { text = localize("fur_corruptediridia_5"), colour = G.C.UI.TEXT_DARK, scale = 0.32 } },
                    }},
                    { n = G.UIT.R, config = { align = "cm", padding = 0.02 }, nodes = {
                        { n = G.UIT.T, config = { text = localize("fur_corruptediridia_6"), colour = G.C.UI.TEXT_DARK, scale = 0.32 } },
                        { n = G.UIT.T, config = { text = localize("k_fur_rarityfurrynonmythic"), colour = G.C.DARK_EDITION, scale = 0.32 } },
                        { n = G.UIT.T, config = { text = localize("fur_corruptediridia_7"), colour = G.C.UI.TEXT_DARK, scale = 0.32 } },
                        { n = G.UIT.O, config = {
                            object = DynaText({
                                string = moneytable,
                                colours = { G.C.MONEY },
                    ...
                    { n = G.UIT.R, config = { align = "cm", padding = 0.02 }, nodes = {
                        { n = G.UIT.O, config = {
                            object = DynaText({
                                string = corruptiridia_lines.normal,
                    ...
                    { n = G.UIT.R, config = { align = "bm", padding = 0.02 }, nodes = {
                        { n = G.UIT.T, config = { text = "OC: ", colour = G.C.UI.TEXT_INACTIVE, scale = 0.24 } },
                        { n = G.UIT.T, config = { text = "Kris_57", colour = G.C.FILTER, scale = 0.24 } },
                    }},
                }
            else
                main_start = {
                    ...
                    { n = G.UIT.R, config = { align = "cm", padding = 0.02 }, nodes = {
                        { n = G.UIT.O, config = {
                            object = DynaText({
                                string = corruptiridia_lines.toggle,
                                colours = { G.C.UI.TEXT_INACTIVE },
                                pop_in_rate = 9999999,
                                silent = true,
                                random_element = true,
        ...
        update = function(self, card, dt)
            ...
            card.ability.dtpassed = card.ability.dtpassed + dt
            if card.ability.dtpassed > 0.6 then
                card.ability.dtpassed = card.ability.dtpassed - 0.6
                card.ability.extra.xmult = multtable[math.random(#multtable)]
                card.ability.extra.money = moneytable[math.random(#moneytable)]
            end
    ...
    SMODS.Joker {
        key = "corruptiridia",
        config = { dtpassed = 0, extra = { xmult = 0, money = 0 }},
        atlas = 'corruptiridiaslab',
        pos = { x = 1, y = 0 },
        soul_pos = { x = 0, y = 0 },
        rarity = "fur_rarityfurrycorrupt",
