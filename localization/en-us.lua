return {
	["descriptions"] = {
		...
		["Enhanced"] = {
			...
			["m_fur_princecard"] = {
				...
				["text"] = {
					"{C:mult}+#1#{} Mult",
					"Gains {C:mult}+#2#{} Mult for each {C:attention}Prince",
		...
		["Joker"] = {
			...
			["j_fur_spark"] = {
				...
				["text"] = {
            		...
            		'when {C:attention}2s{} of any suit or',
            		'{C:diamonds}#4#{} of any rank are scored',
			...
			["j_fur_curiousangel"] = {
				...
				["text"] = {
            		...
            		'{C:dark_edition}#6#{} to scored cards or Jokers',
			...
			["j_fur_talismanxavierorjose"] = {
				...
				["text"] = {
            		...
            		'cards to a random enhancement',
            		'{C:green}#3# in #4#{} chance to {C:attention}remove{} the enhancement',
            		'from scored cards for {X:money,C:white}+X#5#{} {C:money}$',
            		'At {C:attention}end of round{}, gives {C:money}${} equal to',
					'{C:inactive}({C:money}current ${C:inactive} x {C:money}#6#{C:inactive})',
			...
			["j_fur_xavierorjose"] = {
				...
				["text"] = {
            		...
            		'{C:green}#3# in #4#{} chance to {C:attention}remove{} the',
            		'enhancement from scored cards for {C:money}+$#6#{}',
            		'At {C:attention}end of round{}, gives {C:money}$#5#{}',
            		'{C:inactive,s:0.8,E:2}#7#',
				},
			},
			["j_fur_foxxlyduskfur"] = {
				...
				["text"] = {
					...
					'items from the shop',
					'{C:dark_edition}Synergy:{} Mult scales twice as',
					'fast if you have {C:attention}Dusk',
					'{C:inactive}(Currently {X:mult,C:white}X#1#{C:inactive} Mult)',
					'{C:inactive,s:0.8,E:2}#3#',
			...
			["j_fur_talismancorruptcuriousangel"] = {
				...
				["text"] = {
					'Applies {C:dark_edition}#4#{} to scored cards or Jokers',
			...
			["j_fur_talismancorruptsparkles"] = {
				...
				["text"] = {
					'This Bunny scores {X:dark_edition,C:white}^#1#{} Mult and',
					'levels up played poker hand by {C:attention}#2#',
			...
			["j_fur_corruptsparkles"] = {
				["name"] = "SparklesRolf (Hate)",
				["text"] = {
					'This Bunny scores {X:mult,C:white}X#1#{} Mult and',
					'levels up played poker hand by {C:attention}#2#',
					'when cards with {C:hearts}#4#{} suit are scored',
					'{V:1,s:1.2,E:1}#3#',
					'{C:inactive,s:0.8,E:1}AU: {C:attention,s:0.8,E:1}UNDERTALE',
			...
			["j_fur_talismandanny"] = {
				["name"] = "Danny",
				["text"] = {
					"This CatDragon {C:red}debuffs{} all non-{C:fur_stars}#3#{} cards",
                	"For each played hand that contains a {C:attention}Flush{}, add",
                	"{X:dark_edition,C:white}^#2#{} Mult and apply a {C:blue}Blue Paw Seal{} to scored cards",
                	"then give {X:dark_edition,C:white}^#1#{} Mult",
					"{C:inactive,s:0.8,E:2}#4#",
				},
			},
			["j_fur_danny"] = {
				...
				["text"] = {
					"This CatDragon {C:red}debuffs{} all non-{C:fur_stars}#3#{} cards",
                	"For each played hand that contains a {C:attention}Flush{}, add",
                	"{X:mult,C:white}X#2#{} Mult and apply a {C:blue}Blue Paw Seal{} to scored cards",
                	"then give {X:mult,C:white}X#1#{} Mult",
					"{C:inactive,s:0.8,E:2}#4#",
				},
			},
			["j_fur_diablo2324"] = {
			...
			["j_fur_nemzata"] = {
				["name"] = "Nemzata",
				["text"] = {
					"When a card is {C:red}eliminated{} by {C:attention}Nemz's Bow",
			...
			["j_fur_talismancorruptdanny"] = {
				...
				["text"] = {
                	...
                	"For each played hand that contains a {C:attention}Flush{}, add",
                	"{X:dark_edition,C:white}^#2#{} Mult, {C:dark_edition}#4#{}, and a {C:blue}Blue Paw Seal{} to scored cards",
                	"then give {X:dark_edition,C:white}^#1#{} Mult",
                	"{C:inactive,s:0.8,E:2}#5#",
				},
			},
			["j_fur_corruptdanny"] = {
				...
				["text"] = {
                	...
                	"{C:red}Destroys{} all non-{C:fur_stars}#3#{} cards in hand {C:attention}after{} playing a hand",
                	"For each played hand that contains a {C:attention}Flush{}, add",
                	"{X:mult,C:white}X#2#{} Mult, {C:dark_edition}#4#{}, and a {C:blue}Blue Paw Seal{} to scored cards",
                	"then give {X:mult,C:white}X#1#{} Mult",
					"{C:inactive,s:0.8,E:2}#5#",
				},
			},
			["j_fur_iridia"] = {
				...
				["text"] = {
					...
					"played poker hand if you have {C:dark_edition}Kris_57",
					"{C:inactive}(Must have room)",
            		"{C:inactive,s:0.8,E:2}#3#",
			...
			["j_fur_maltnoodlez"] = {
				["name"] = "MaltNoodlez",
				["text"] = {
					"When selecting blinds this Bunny {C:red}debuffs",
            		"one random Joker until {C:attention}end of round",
            		"{C:inactive}(Excluding itself)",
					"While playing a round, copy the",
			...
			["j_fur_schnackiofficial"] = {
				...
				["text"] = {
					...
					"{C:dark_edition}Synergy:{} Multiply the Mult given by",
			...
			["j_fur_ych"] = {
				["name"] = "YCH",
				["text"] = {
					"When selecting blinds, copy the",
					"form of a random {C:dark_edition}Furry{} Joker",
					"{C:inactive}(Except corrupted Jokers)",
					"After {C:attention}#1#{} rounds, sell this YCH to",
					"{C:attention}duplicate{} the copied {C:dark_edition}Furry",
					"{C:inactive}(Currently {C:attention}#2#{C:inactive}/#1#)"
				}
			},
			["j_fur_ignarilassacire"] = {
				["name"] = "Ignaril Assacire",
				["text"] = {
					"Retrigger all {C:dark_edition}Furry{} Jokers",
			...
			["j_fur_potmario"] = {
				["name"] = "PotMario",
				["text"] = {
					"This Cat gains {C:chips}+#3#{} chips and {X:mult,C:white}X#4#{} Mult",
					"for each owned {C:dark_edition}Furry{} Joker",
					"If this is your only Joker, gain {C:money}$#5#{} per round",
					"and a {C:attention}Double Tag{} at the end of the {C:attention}#6#",
					"{C:inactive}(Currently {C:chips}+#1#{C:inactive} chips and {X:mult,C:white}X#2#{C:inactive} Mult)",
					"{C:inactive,s:0.8,E:2}#7#",
				},
			},
			["j_fur_aberrantreptile"] = {
				["name"] = "AberrantReptile",
				["text"] = {
					"This Snake has a {C:green}#5# in #6#{} chance to apply a {C:blue}Blue Seal",
					"to scored cards without a seal",
					"Create a {C:dark_edition}#3#{C:planet} #4#{} card for the played",
					"{C:attention}Poker Hand{} when cards with a {C:blue}Blue Seal{} are scored",
					"Retrigger all {C:blue}Blue Seal{} cards {C:attention}#1#{} additional time(s)",
					"{C:inactive,s:0.8,E:2}#2#",
				},
			},
			["j_fur_gale"] = {
				["name"] = "Gale",
				["text"] = {
					"Converts played {C:red}debuffed{} or {C:attention}Stone Cards",
					"into {C:attention}Snowflake Cards{} regardless of scoring",
					"This Arctic Hare gains {C:chips}+#1#{} chips and {C:mult}+#2#{} Mult",
					"for each {C:attention}Snowflake Card{} in your full deck",
					"If played hand contains only {C:attention}Snowflake Cards{}",
					"score {X:mult,C:white}X#5#{} Mult at the end of calculation",
					"{C:inactive}(Currently {C:chips}+#3#{C:inactive} chips and {C:mult}+#4#{C:inactive} Mult)",
					"{C:inactive,s:0.8,E:2}#6#",
					"{C:inactive,s:0.8,E:1}OC: {C:attention,s:0.8,E:1}Danny",
				},
			},
			["j_fur_corruptiridia"] = { -- See dictionary for effect text
				["name"] = "Iridia (Corrupted)",
				["text"] = {
					"",
					"",
					"",
			...
			["j_fur_talismancorruptiridia"] = { -- echo above
				["name"] = "Iridia (Corrupted)",
				["text"] = {
					"",
					"",
		...
		["Mod"] = {
			["Furlatro"] = {
				...
				["text"] = {
					...
					" ",
					"Introduces {C:attention}38 {C:dark_edition,E:1,s:1.3}Furry{} Jokers, each with unique effects!",
					...
					"And a special thanks to {C:attention,E:2,s:1.3}TheOneGoofAli{} for code help <3",
					" ",
					...
					"Tarot card texture pack by {C:attention,E:2,s:1.3}ScruffyBrush",
					" ",
		...
		["Other"] = {
			...
			["fur_orangepawseal_seal"] = {
				...
				["text"] = {
            		...
            		'Gives {C:money}$#3#{}',
            		'{C:green}#6# in #4#{} chance for a {C:tarot}#8#{} card',
            		'{C:green}#7# in #5#{} chance for a {C:spectral}#9#{} card',
            		'{C:inactive}(Must have room)',
				},
			},
		},
		["Partner"] = {
			...
			["pnr_fur_sparklespartner_alt"] = {
				["name"] = "SparklesRolf",
				["text"] = {
					"First scored card with {C:fur_stars}#3#",
			...
			["pnr_fur_silverpartner_alt"] = {
				["name"] = "SilverSentinel",
				["text"] = {
					"First scored {C:attention}Silver Card",
			...
			["pnr_fur_cobaltpartner_alt"] = {
				["name"] = "CobaltTheBluPanda",
				["text"] = {
					"First scored card with {C:clubs}#3#",
			...
			["pnr_fur_iceseapartner_alt"] = {
				["name"] = "IceSea",
				["text"] = {
					"First scored {C:attention}Bonus Card",
					"spawns {C:tarot,T:c_hierophant}The Hierophant",
					"{C:inactive}(Works once per round)",
			...
			["pnr_fur_konekopartner_alt"] = {
				["name"] = "The_Koneko",
				["text"] = {
					"First scored card with {C:hearts}#3#",
			...
			["pnr_fur_sparkpartner"] = {
				["name"] = "SparkTheBird",
				["text"] = {
					"First scored card gives {X:mult,C:white}X#1#{} Mult",
            		"when {C:attention}2s{} of any suit or",
            		"{C:diamonds}#4#{} of any rank are scored",
            		"{X:mult,C:white}X#2#{} Mult if a {C:attention}2{} of {C:diamonds}#4#{}",
					"is scored",
			...
			["pnr_fur_sparkpartner_alt"] = {
				["name"] = "SparkTheBird",
				["text"] = {
					"First scored card with {C:diamonds}#4#",
			...
			["pnr_fur_curiousangelpartner"] = {
				["name"] = "CuriousAngel",
				["text"] = {
					"If the first {C:attention}scored card{} is {C:dark_edition}#3#",
					"this DeerFox gains {X:mult,C:white}X#4#{} Mult",
					"if its not, it has a {C:green}#1# in #2#{} chance to become {C:dark_edition}#3#",
			...
			["pnr_fur_sephirapawspartner"] = {
				...
				["text"] = {
            		...
            		"playing card in your {C:attention}full",
					"{C:attention}deck{} when you discard your",
			...
			["pnr_fur_maltnoodlezpartner"] = {
				["name"] = "MaltNoodlez",
				["text"] = {
					"When setting blinds {C:red}debuff",
            		"one random Joker until {C:attention}end of round",
					"While playing a round, copy the",
            		"ability of the {C:attention}rightmost{} Joker",
				},
			...
			["pnr_fur_schnackiofficialpartner_alt"] = {
				["name"] = "SchnackiOfficial",
				["text"] = {
					"First scored card with {C:spades}#3#",
			...
			["pnr_fur_dannypartner"] = {
				...
				["text"] = {
                	...
                	"then give {X:mult,C:white}X#2#{} Mult",
				},
				["unlock"] = {
					"Win a run with",
			...
			["pnr_fur_parrotdashpartner_alt"] = {
				...
				["text"] = {
					...
					"{C:inactive}(Except #3# and #4#)",
				},
			},
			["pnr_fur_lumepartner"] = {
				["name"] = "Lume",
				["text"] = {
					"If the first scored card is a",
					"{C:attention}Prince{} card, this DragonCat gives {X:mult,C:white}X#1#{} Mult",
					"if its not, enhance it to a {C:attention}Prince{} card if its a {C:attention}Face Card",
				},
			},
			...
			["pnr_fur_galepartner"] = {
				["name"] = "Gale",
				["text"] = {
					"Converts the first {C:red}debuffed{} or {C:attention}Stone Card",
					"into a {C:attention}Snowflake Card{} regardless of scoring",
					"This Arctic Hare gains {C:chips}+#1#{} chips and {C:mult}+#2#{} Mult",
					"for each {C:attention}Snowflake Card{} in your full deck",
					"If played hand contains only {C:attention}Snowflake Cards{}",
					"score {X:mult,C:white}X#5#{} Mult at the end of calculation",
			...
			["pnr_fur_galepartner_alt"] = {
				["name"] = "Gale",
				["text"] = {
					"{C:attention}Double{} the scaling and {X:mult,C:white}XMult",
					"for {C:dark_edition}Gale",
					"{C:attention}Double{} the values for {C:attention}Snowflake Cards",
				},
			},
			["pnr_fur_aberrantreptilepartner"] = {
				["name"] = "AberrantReptile",
				["text"] = {
					"This Snake creates a {C:dark_edition}#3# {C:planet}#4#{} card for",
					"every {C:attention}2nd{} scored card with a {C:blue}Blue Seal",
					"Retrigger that card {C:attention}#2#{} additional time(s)",
					"{C:inactive}({C:attention}#1# {C:inactive}Remaining)",
				},
			},
			["pnr_fur_aberrantreptilepartner_alt"] = {
				["name"] = "AberrantReptile",
				["text"] = {
					"{C:attention}Double{} the retriggers",
					"for {C:dark_edition}AberrantReptile",
				},
			},
			["pnr_fur_ignarilassacirepartner"] = {
				["name"] = "Ignaril Assacire",
				["text"] = {
					"Retrigger every {C:attention}2nd{C:dark_edition} Furry{} Joker",
					"{C:attention}#2#{} additional time(s)",
					"{C:inactive}({C:attention}#1#{C:inactive} Remaining)",
				},
			},
			["pnr_fur_ignarilassacirepartner_alt"] = {
				["name"] = "Ignaril Assacire",
				["text"] = {
					"{C:attention}Double{} the retriggers",
					"from {C:dark_edition}Ignaril Assacire"
				},
			},
			["pnr_fur_potmariopartner"] = {
				["name"] = "PotMario",
				["text"] = {
					"This Cat gains {C:chips}+#3#{} chips and {X:mult,C:white}X#4#{} Mult",
					"for each owned {C:dark_edition}Furry{} Joker",
					"If you own a singular Joker, gain {C:money}$#5#{} per round",
					"and a {C:attention}Double Tag{} at the end of the {C:attention}#6#",
					"{C:inactive}(Currently {C:chips}+#1#{C:inactive} chips and {X:mult,C:white}X#2#{C:inactive} Mult)",
				},
			},
			["pnr_fur_potmariopartner_alt"] = {
				["name"] = "PotMario",
				["text"] = {
					"{C:attention}Doubles{} the scaling and",
					"tags for {C:dark_edition}PotMario",
				},
			},
		},
		["Planet"] = {
		...
		["Voucher"] = {
			["v_fur_furrymeetup"] = {
				["name"] = "Fur Meet",
				["text"] = {
					"non-{C:common}Mythic {C:dark_edition}Furries{} can now",
					"appear in the shop and Buffoon Packs",
				},
			},
			["v_fur_furryconvention"] = {
				["name"] = "Furry Convention",
				["text"] = {
					"{C:common}Mythic {C:dark_edition}Furries{} can now",
					"appear in the shop and Buffoon Packs",
				},
			},
			["v_fur_boykisservoucher"] = {
				["name"] = "Boykissers?",
				["text"] = {
					"You like redeeming vouchers",
					"don't you"
				},
			},
		},
	...
	["misc"] = {
		["achievement_descriptions"] = {
			...
			["ach_fur_snowedin"] = {
				"Have 52 or more Snowflake Cards",
				"in your deck in a single run",
			},
		},
		["achievement_names"] = {
			...
			["ach_fur_snowedin"] = "Snowed In",
		},
		["challenge_names"] = {
			["c_fur_challengechipsmaxing"] = "Chips Maxing",
			["c_fur_challengemultmaxing"] = "Mult Maxing",
			["c_fur_challengenegativenancy"] = "Negative Nancy",
			["c_fur_challengesnowday"] = "Snow Day",
			["c_fur_challengecardconjuring"] = "Card Conjuring",
			["c_fur_challengehighroyalty"] = "High Royalty",
		},
		["collabs"] = {
			["Clubs"] = {
		...
		["dictionary"] = {
			["k_fur_rarityfurrynonmythic"] = "Furry",
			["k_fur_rarityfurrymythic"] = "Furry",
			["k_fur_rarityfurrycorrupt"] = "Furry",
			["fur_developer"] = "Developer",
			...
			["fur_snowflakecardtrigger"] = "Frozen!",
			...
			["fur_corruptediridia_1"] = "This Joker gives ",
			["fur_corruptediridia_2"] = " Mult when ",
			["fur_corruptediridia_3"] = "\'s, ",
			["fur_corruptediridia_4"] = ", or ",
			["fur_corruptediridia_5"] = " cards are scored",
			["fur_corruptediridia_6"] = "For every ",
			["fur_corruptediridia_7"] = " Joker, give ",
		},
		["labels"] = {
			["fur_mythic"] = "Mythic",
		...
		["v_text"] = {
			...
			["ch_c_fur_gale_start"] = {"Start the run with an {C:legendary}Eternal{} {C:dark_edition}Gale"},
			["ch_c_fur_snowy_face"] = {"All starting Face Cards are {C:attention}Snowflake Cards"},
			["ch_c_fur_conjuring_start"] = {"Start the run with an {C:legendary}Eternal{} {C:dark_edition}AstralWarden"},
			["ch_c_fur_conjuring_start_2"] = {"{C:dark_edition}SaphiélleFox{}, and {C:dark_edition}AberrantReptile"},
			["ch_c_fur_highroyalty_start"] = {"Start the run with an {C:legendary}Eternal{} {C:rare}Baron{}, {C:dark_edition}illyADo{}, and {C:dark_edition}Lume"},
			["ch_c_fur_highroyalty_start2"] = {"All starting Face Cards are {C:attention}Kings"},
			["ch_c_fur_ante12_win"] = {"Winning Ante is now Ante {C:attention}12"},
			["ch_c_fur_ante16_win"] = {"Winning Ante is now Ante {C:attention}16"},
		},
    },
}